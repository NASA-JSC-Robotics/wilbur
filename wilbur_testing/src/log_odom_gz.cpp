  ...
  public:
    ...
    , odInit_(false)
    {
      ...
      std::string theta_dot_str = to_string_with_precision<double>(this->get_parameter("theta_dot").as_double(), 2);
       ...
       gtSubscription_ = this->create_subscription<geometry_msgs::msg::PoseStamped>(
      "/ground_truth/pose", 10, std::bind(&DataSubscriber::ground_truth_callback, this, _1));
       odSubscription_ = this->create_subscription<nav_msgs::msg::Odometry>(
      "/odom", 10, std::bind(&DataSubscriber::odom_callback, this, _1));
